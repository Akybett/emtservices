...
const services = [
  ...
  },
  {
    ...
    description:
      "We bring in specialist stewards for each event rather than maintaining a permanent roster. This keeps us flexible and ensures the right personnel are matched to the right event. Our stewards come to us through personal recommendation and are vetted directly — not sourced from an agency pool.",
    icon: Users,
    image: stewardingImg,
    imageAlt:
              ...
              <Card className="h-full flex flex-col border-border bg-card hover:border-primary/50 hover:shadow-lg transition-all duration-300 overflow-hidden">
                ...
                <CardContent className="flex flex-col flex-1 p-6">
                  <div className="flex items-center gap-3 mb-3">
                    <div className="w-11 h-11 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0 text-primary">
